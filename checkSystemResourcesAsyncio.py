...
async def check_internet(host='8.8.8.8', port=53, timeout=3):     # Check if the system can reach the internet. Use an IPv4 address to prevent DNS errors.
    """
...
async def check_DNS(host='google-public-dns-a.google.com', timeout=3):        # Check if DNS is working properly and the system is correctly resolving host names.
