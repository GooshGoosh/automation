...
def main():
    try:
        ...
        one_letter_words(textFileLines)
        two_letter_words(textFileLines)
        three_letter_words(textFileLines)
        four_letter_words(textFileLines)
        five_letter_words(textFileLines)
        six_letter_words(textFileLines)
        seven_letter_words(textFileLines)
